...
//**********************************************************************************InterviewModal**********************************************************************************************************
  ...
  return (
    ...
    >
      ...
      {selectedCandidate&&(
        ...
        >
          <Box sx={style} borderRadius={2}>
            <Box borderBottom={1} borderColor={"lightgray"}>
              ...
              <Typography >Candidate name : {selectedCandidate?.fName+" "+selectedCandidate?.lName}</Typography>
            ...
            <Box marginTop={2}>
              ...
              <TextField margin="normal" required  value={date} onChange={(e)=>setDate(e.target.value)} type="date" fullWidth />
            </Box>
            <Box marginTop={2}>
              <Typography
                gutterBottom
              ...
              <Box marginTop={1}>
                <TimePicker onChange={(newTime)=>setStartTime(newTime)} value={startTime} sx={{ width: "100%" }} label="Start time" />
       ...
       {interviewMode==='In-Person'&&
        <FormControl fullWidth>
                  <TextField  value={location} onChange={(e)=>setLocation(e.target.value)} required name="location" label="Location" />
                </FormControl>}
     ...
     <Button color="primary" variant="contained" type="submit">Shedule</Button>
