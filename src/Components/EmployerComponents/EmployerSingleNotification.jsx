...
import { setEmployerUnreadNotifications, setUpdated } from '../../app/features/employerSlice'

function EmployerSingleNotification({handleDeleteNotification,e}) {
const dispatch=useDispatch()  
 useEffect(()=>{
 if (e&&!e.read) {
    handleUpdateNotification(e._id,'employer')
...
export default EmployerSingleNotification
